...
export default function Home() {
  return (
    <div className="min-h-screen bg-black flex flex-col overflow-x-clip font-sans">

      {/* Mega Menu Navigation */}
      <Navigation />

      {/* Hero Section - Black (Native scrolling) */}
      <section className="relative w-full bg-black bg-grid flex flex-col items-start justify-center min-h-[75vh] pt-20 pb-20 px-6 md:px-12 lg:px-24">
